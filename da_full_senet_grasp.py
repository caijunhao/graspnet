...
from model import model, model_arg_scope, se_model, full_senet
...
parser.add_argument('--output_path', default='da_full_se_result', type=str, help='output path.')
...
def main():
    ...
    with slim.arg_scope(model_arg_scope()):
        net, end_points = full_senet(inputs=images_t,
