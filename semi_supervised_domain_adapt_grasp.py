...
parser.add_argument('--reach_distance', default=0.007, type=float, help='meters')
...
parser.add_argument('--checkpoint_dir', default='/home/caijunhao/Desktop/domain_adaptation_for_grasping/logs_semi_supervised_domain_adapt_3088',
...
origin = (0.3248623311305044, 0.7625734697391529, 0.01)  # (0.39397914313440474, -0.6462901096088043)
...
def main():
    ...
    while not rospy.is_shutdown() and t != 10:
        ...
        while flag != 1:
            ...
            d_x = float(c_x) / 1000.0 + 0.04
            d_y = float(c_y) / 1000.0 + 0.01
            x = origin[0]+d_x
            y = origin[1]-d_y
            z = origin[2]
