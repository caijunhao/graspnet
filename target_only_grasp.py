...
parser.add_argument('--checkpoint_dir', default='/home/caijunhao/Desktop/domain_adaptation_for_grasping/logs_target_only_3088',
                    type=str, help='Path where the checkpoint file locate.')
parser.add_argument('--output_path', default='target_only_3088_result', type=str, help='output path.')  # source_only_result
